...
insert into orders(orderId, userId, total, dateBuy, status) values
    (6,15,8000,'2022-2-2',true);
		insert into user(userId,username,email,password,birthdate,phoneNumber,address,status,role) values
		(2,'admin','admin@gmail.com','admin','2023-8-23','0123456789','Ha Noi',true,true),
        (3,'tanphat','phat@gmail.com','phat2004','2022-2-2','0123456789','Ha Noi',true,false)
        ;
